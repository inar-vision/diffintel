...
> **Status**: Future — depends on Phase 1. Can run in parallel with Phase 2.
...
### Validation Loop
- Phase 1 introduces re-running `check` after apply — Phase 3 makes this robust
...
- Browsable from the dashboard (Phase 4 integration)
...
- Autonomous (auto-merge if all checks pass — Phase 5 feature, requires policy framework)
