...
> **Status**: Future — can start partially alongside Phase 2 (publishing the spec), but ecosystem work depends on adoption.
...
- Phase 2 analyzer interface must be proven
